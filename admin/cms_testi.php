...
$query = "SELECT * FROM tb_testimonials";
...
<div class="container mt-5" style="min-height: calc(100vh - 200px);">
    <div class="bg-white p-4 rounded shadow">
        ...
        <a href="add_testi.php" class="btn btn-success mb-3">Add New <?php echo ucfirst($category); ?></a>
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM tb_testimonials WHERE id = :id";
